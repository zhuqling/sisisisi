package com.yizan.community.widget.stickylistheaders;
...
//                mList.setScrollBarStyle(a.getInt(R.styleable.StickyListHeadersListView_android_scrollbarStyle, View.SCROLLBAR_POSITION_DEFAULT));
